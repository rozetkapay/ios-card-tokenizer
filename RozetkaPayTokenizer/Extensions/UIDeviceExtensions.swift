...
extension UIDevice {
    ...
    static let version: String = {
        return Bundle.rozetkapayTokenSDKBundle?.infoDictionary?["CFBundleShortVersionString"] as? String ?? ""
    }()
    
    static let appName: String = {
        return Bundle.rozetkapayTokenSDKBundle?.infoDictionary?["CFBundleDisplayName"] as? String ?? ""
    }()
}
